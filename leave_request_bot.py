...
# 1. 发送不带 verifyCode 的请求
data_1 = data_no_verify.copy()
send_request(data_1, "Without verifyCode")

# 2. 发送 verifyCode=000000
data_2 = data_no_verify.copy()
data_2["verifyCode"] = "000000"
send_request(data_2, "verifyCode 000000")

# 3. 发送 verifyCode=123456
data_3 = data_no_verify.copy()
data_3["verifyCode"] = "123456"
send_request(data_3, "verifyCode 123456")
